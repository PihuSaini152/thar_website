...
const AdminPanel = () => {
  ...
  const fetchBookings = async () => {
    setLoading(true);
    try {
      const response = await fetch('https://thar-website.onrender.com/api/admin/bookings');
  ...
  const updateStatus = async (bookingId, newStatus) => {
    try {
      const response = await fetch(`https://thar-website.onrender.com/api/admin/update-status/${bookingId}`, {
        method: 'PUT',
        headers: {
